...
var callerSugaredLog *zap.SugaredLogger
var defaultLogOnce sync.Once
...
func InitLog(config *config.ZapConfig) {
	...
	callerSugaredLog = sugaredLog.WithOptions(zap.AddCallerSkip(1))
}

func ensureLogger() {
	if log != nil && sugaredLog != nil {
		return
	}
...
func Debugf(msg string, param ...any) {
	...
	callerSugaredLog.Debugf(msg, param...)
}
...
func Infof(msg string, param ...any) {
	...
	callerSugaredLog.Infof(msg, param...)
}
...
func Warnf(msg string, param ...any) {
	...
	callerSugaredLog.Warnf(msg, param...)
}
...
func Errorf(msg string, param ...any) {
	...
	callerSugaredLog.Errorf(msg, param...)
}

func Panicf(msg string, param ...any) {
	ensureLogger()
	callerSugaredLog.Panicf(msg, param...)
}

func Fatalf(msg string, param ...any) {
	ensureLogger()
	callerSugaredLog.Fatalf(msg, param...)
}
